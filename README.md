[![Build Status](https://app.travis-ci.com/Nimirandad/echo-boilerplate.svg?branch=main)](https://app.travis-ci.com/Nimirandad/echo-boilerplate)
[![codecov](https://codecov.io/gh/Nimirandad/echo-boilerplate/branch/main/graph/badge.svg?token=hxaHIVyoBN)](https://codecov.io/gh/Nimirandad/echo-boilerplate)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](https://github.com/Nimirandad/echo-boilerplate/blob/master/LICENSE)
[![Go Reference](https://pkg.go.dev/badge/github.com/Nimirandad/echo-boilerplate.svg)](https://pkg.go.dev/github.com/Nimirandad/echo-boilerplate)
[![GoReportCard Badge](https://goreportcard.com/badge/github.com/Nimirandad/echo-boilerplate)](https://goreportcard.com/report/github.com/Nimirandad/echo-boilerplate)
[![Total alerts](https://img.shields.io/lgtm/alerts/g/Nimirandad/echo-boilerplate.svg?logo=lgtm&logoWidth=18)](https://lgtm.com/projects/g/Nimirandad/echo-boilerplate/alerts/)
...
> **DO NOT FORK** this is meant to be used from **[Use this template](https://github.com/Nimirandad/echo-boilerplate/generate)** feature.

1. Click on **[Use this template](https://github.com/Nimirandad/echo-boilerplate/generate)**
